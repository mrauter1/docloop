...
## Required outputs
Update `.superloop/tasks/implement-refined-reflow-v1-2-sad-md-as-function-c56ff427/plan/plan.md` as the single source of truth for the plan, including milestones, interface definitions, and risk register details in that one file.

Also append a concise entry to `.superloop/tasks/implement-refined-reflow-v1-2-sad-md-as-function-c56ff427/plan/feedback.md` with what changed and why.
...
5. Do not edit `.superloop/tasks/implement-refined-reflow-v1-2-sad-md-as-function-c56ff427/plan/criteria.md` (verifier-owned).
