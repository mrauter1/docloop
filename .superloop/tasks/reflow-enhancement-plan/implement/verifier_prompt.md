...
## Required actions
1. Update `.superloop/tasks/reflow-enhancement-plan/implement/criteria.md` checkboxes accurately.
2. Append prioritized review findings to `.superloop/tasks/reflow-enhancement-plan/implement/feedback.md` with stable IDs (for example `IMP-001`).
...
## Rules
- Do not modify non-`.superloop/tasks/reflow-enhancement-plan/` code files.
