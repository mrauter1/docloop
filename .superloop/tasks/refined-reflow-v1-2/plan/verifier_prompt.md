...
## Required actions
1. Update `.superloop/tasks/refined-reflow-v1-2/plan/criteria.md` checkboxes accurately.
2. Append prioritized findings to `.superloop/tasks/refined-reflow-v1-2/plan/feedback.md` with stable IDs (for example `PLAN-001`).
