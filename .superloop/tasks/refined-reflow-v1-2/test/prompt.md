...
- Update `.superloop/tasks/refined-reflow-v1-2/test/test_strategy.md` with an explicit behavior-to-test coverage map.
- Append a concise entry to `.superloop/tasks/refined-reflow-v1-2/test/feedback.md` summarizing test additions.
...
5. Do not edit `.superloop/tasks/refined-reflow-v1-2/test/criteria.md` (auditor-owned).
