...
## Required actions
1. Update `.superloop/tasks/refined-reflow-v1-2/test/criteria.md` checkboxes accurately.
2. Append prioritized audit findings to `.superloop/tasks/refined-reflow-v1-2/test/feedback.md` with stable IDs (for example `TST-001`).
...
## Rules
- Do not edit repository code except `.superloop/tasks/refined-reflow-v1-2/test/*` audit artifacts.
