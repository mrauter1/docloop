...
## Working set
- Entire repository
- `.superloop/tasks/refined-reflow-v1-2/context.md`
- `.superloop/tasks/refined-reflow-v1-2/implement/feedback.md`
- `.superloop/tasks/refined-reflow-v1-2/plan/plan.md`
...
6. Map your edits to the implementation checklist in `.superloop/tasks/refined-reflow-v1-2/plan/plan.md` when present, and note any checklist item you intentionally defer.
7. Update `.superloop/tasks/refined-reflow-v1-2/implement/implementation_notes.md` with: files changed, checklist mapping, assumptions, expected side effects, and any deduplication/centralization decisions.
8. Do not edit `.superloop/tasks/refined-reflow-v1-2/implement/criteria.md` (reviewer-owned).
