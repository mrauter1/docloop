...
## Required actions
1. Update `.superloop/tasks/refined-reflow-v1-2/implement/criteria.md` checkboxes accurately.
2. Append prioritized review findings to `.superloop/tasks/refined-reflow-v1-2/implement/feedback.md` with stable IDs (for example `IMP-001`).
...
## Rules
- Do not modify non-`.superloop/tasks/refined-reflow-v1-2/` code files.
