...
- Update `.superloop/tasks/autosac-prd-plan/test/test_strategy.md` with an explicit behavior-to-test coverage map.
- Append a concise entry to `.superloop/tasks/autosac-prd-plan/test/feedback.md` summarizing test additions.
...
8. Do not edit `.superloop/tasks/autosac-prd-plan/test/criteria.md` (auditor-owned).
