...
## Required actions
1. Update `.superloop/tasks/autosac-prd-plan/test/criteria.md` checkboxes accurately.
2. Append prioritized audit findings to `.superloop/tasks/autosac-prd-plan/test/feedback.md` with stable IDs (for example `TST-001`).
...
## Rules
- Do not edit repository code except `.superloop/tasks/autosac-prd-plan/test/*` audit artifacts.
