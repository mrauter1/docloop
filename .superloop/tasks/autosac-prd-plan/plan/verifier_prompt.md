...
## Required actions
1. Update `.superloop/tasks/autosac-prd-plan/plan/criteria.md` checkboxes accurately.
2. Append prioritized findings to `.superloop/tasks/autosac-prd-plan/plan/feedback.md` with stable IDs (for example `PLAN-001`).
