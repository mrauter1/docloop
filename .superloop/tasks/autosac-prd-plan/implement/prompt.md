...
- `.superloop/tasks/autosac-prd-plan/implement/feedback.md`
- `.superloop/tasks/autosac-prd-plan/plan/plan.md`
- `.superloop/tasks/autosac-prd-plan/implement/implementation_notes.md`
...
8. Treat the active phase contract as authoritative scoped work for implement/test runs. Any intentional out-of-phase change must be explicitly justified in `.superloop/tasks/autosac-prd-plan/implement/implementation_notes.md`.
9. Map your edits to the implementation checklist in `.superloop/tasks/autosac-prd-plan/plan/plan.md` when present, and note any checklist item you intentionally defer.
10. Update `.superloop/tasks/autosac-prd-plan/implement/implementation_notes.md` with: files changed, checklist mapping, assumptions, expected side effects, and any deduplication/centralization decisions.
...
12. Do not edit `.superloop/tasks/autosac-prd-plan/implement/criteria.md` (reviewer-owned).
