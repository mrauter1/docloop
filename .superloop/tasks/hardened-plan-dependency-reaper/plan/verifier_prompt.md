...
## Required actions
1. Update `.superloop/tasks/hardened-plan-dependency-reaper/plan/criteria.md` checkboxes accurately.
2. Append prioritized findings to `.superloop/tasks/hardened-plan-dependency-reaper/plan/feedback.md` with stable IDs (for example `PLAN-001`).
