...
## Required actions
1. Update `.superloop/tasks/hardened-plan-dependency-reaper/test/criteria.md` checkboxes accurately.
2. Append prioritized audit findings to `.superloop/tasks/hardened-plan-dependency-reaper/test/feedback.md` with stable IDs (for example `TST-001`).
...
## Rules
- Do not edit repository code except `.superloop/tasks/hardened-plan-dependency-reaper/test/*` audit artifacts.
