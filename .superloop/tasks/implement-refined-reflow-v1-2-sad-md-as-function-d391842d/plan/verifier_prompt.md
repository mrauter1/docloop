...
## Required actions
1. Update `.superloop/tasks/implement-refined-reflow-v1-2-sad-md-as-function-d391842d/plan/criteria.md` checkboxes accurately.
2. Append prioritized findings to `.superloop/tasks/implement-refined-reflow-v1-2-sad-md-as-function-d391842d/plan/feedback.md` with stable IDs (for example `PLAN-001`).
