...
## Required actions
1. Update `.superloop/tasks/implement-refined-reflow-v1-2-sad-md-as-function-d391842d/test/criteria.md` checkboxes accurately.
2. Append prioritized audit findings to `.superloop/tasks/implement-refined-reflow-v1-2-sad-md-as-function-d391842d/test/feedback.md` with stable IDs (for example `TST-001`).
...
## Rules
- Do not edit repository code except `.superloop/tasks/implement-refined-reflow-v1-2-sad-md-as-function-d391842d/test/*` audit artifacts.
