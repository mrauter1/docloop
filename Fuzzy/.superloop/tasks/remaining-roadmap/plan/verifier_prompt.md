...
## Required actions
1. Update `.superloop/tasks/remaining-roadmap/plan/criteria.md` checkboxes accurately.
2. Append prioritized findings to `.superloop/tasks/remaining-roadmap/plan/feedback.md` with stable IDs (for example `PLAN-001`).
