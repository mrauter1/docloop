...
- `.superloop/tasks/remaining-roadmap/implement/feedback.md`
- `.superloop/tasks/remaining-roadmap/plan/plan.md`
- `.superloop/tasks/remaining-roadmap/implement/implementation_notes.md`
...
8. Map your edits to the implementation checklist in `.superloop/tasks/remaining-roadmap/plan/plan.md` when present, and note any checklist item you intentionally defer.
9. Update `.superloop/tasks/remaining-roadmap/implement/implementation_notes.md` with: files changed, checklist mapping, assumptions, expected side effects, and any deduplication/centralization decisions.
...
11. Do not edit `.superloop/tasks/remaining-roadmap/implement/criteria.md` (reviewer-owned).
