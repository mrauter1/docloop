...
- Update `.superloop/tasks/input-contract-pivot/test/test_strategy.md` with an explicit behavior-to-test coverage map.
- Append a concise entry to `.superloop/tasks/input-contract-pivot/test/feedback.md` summarizing test additions.
...
8. Do not edit `.superloop/tasks/input-contract-pivot/test/criteria.md` (auditor-owned).
