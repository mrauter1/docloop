...
- `.superloop/tasks/input-contract-pivot/implement/feedback.md`
- `.superloop/tasks/input-contract-pivot/plan/plan.md`
- `.superloop/tasks/input-contract-pivot/implement/implementation_notes.md`
...
8. Map your edits to the implementation checklist in `.superloop/tasks/input-contract-pivot/plan/plan.md` when present, and note any checklist item you intentionally defer.
9. Update `.superloop/tasks/input-contract-pivot/implement/implementation_notes.md` with: files changed, checklist mapping, assumptions, expected side effects, and any deduplication/centralization decisions.
...
11. Do not edit `.superloop/tasks/input-contract-pivot/implement/criteria.md` (reviewer-owned).
