...
## Required actions
1. Update `.superloop/tasks/input-contract-pivot/implement/criteria.md` checkboxes accurately.
2. Append prioritized review findings to `.superloop/tasks/input-contract-pivot/implement/feedback.md` with stable IDs (for example `IMP-001`).
...
## Rules
- Do not modify non-`.superloop/tasks/input-contract-pivot/` code files.
