...
## Required outputs
Update `.superloop/tasks/input-contract-pivot/plan/plan.md` as the single source of truth for the plan, including milestones, interface definitions, and risk register details in that one file.

Also append a concise entry to `.superloop/tasks/input-contract-pivot/plan/feedback.md` with what changed and why.
...
5. Do not edit `.superloop/tasks/input-contract-pivot/plan/criteria.md` (verifier-owned).
