...
- Update `.superloop/tasks/remaining-roadmap-all-areas/test/test_strategy.md` with an explicit behavior-to-test coverage map.
- Append a concise entry to `.superloop/tasks/remaining-roadmap-all-areas/test/feedback.md` summarizing test additions.
...
8. Do not edit `.superloop/tasks/remaining-roadmap-all-areas/test/criteria.md` (auditor-owned).
