...
## Required actions
1. Update `.superloop/tasks/remaining-deferrals/test/criteria.md` checkboxes accurately.
2. Append prioritized audit findings to `.superloop/tasks/remaining-deferrals/test/feedback.md` with stable IDs (for example `TST-001`).
...
## Rules
- Do not edit repository code except `.superloop/tasks/remaining-deferrals/test/*` audit artifacts.
