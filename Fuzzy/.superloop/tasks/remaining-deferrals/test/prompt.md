...
- Update `.superloop/tasks/remaining-deferrals/test/test_strategy.md` with an explicit behavior-to-test coverage map.
- Append a concise entry to `.superloop/tasks/remaining-deferrals/test/feedback.md` summarizing test additions.
...
8. Do not edit `.superloop/tasks/remaining-deferrals/test/criteria.md` (auditor-owned).
