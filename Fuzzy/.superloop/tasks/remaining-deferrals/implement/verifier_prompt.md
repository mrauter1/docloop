...
## Required actions
1. Update `.superloop/tasks/remaining-deferrals/implement/criteria.md` checkboxes accurately.
2. Append prioritized review findings to `.superloop/tasks/remaining-deferrals/implement/feedback.md` with stable IDs (for example `IMP-001`).
...
## Rules
- Do not modify non-`.superloop/tasks/remaining-deferrals/` code files.
