...
## Required actions
1. Update `.superloop/tasks/remaining-deferrals/plan/criteria.md` checkboxes accurately.
2. Append prioritized findings to `.superloop/tasks/remaining-deferrals/plan/feedback.md` with stable IDs (for example `PLAN-001`).
