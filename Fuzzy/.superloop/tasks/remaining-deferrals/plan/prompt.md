...
## Required outputs
Update `.superloop/tasks/remaining-deferrals/plan/plan.md` as the single source of truth for the plan, including milestones, interface definitions, and risk register details in that one file.

Also append a concise entry to `.superloop/tasks/remaining-deferrals/plan/feedback.md` with what changed and why.
...
5. Do not edit `.superloop/tasks/remaining-deferrals/plan/criteria.md` (verifier-owned).
